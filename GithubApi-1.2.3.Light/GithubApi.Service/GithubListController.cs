...
namespace GithubApi.Service
{
    ...
    {
        private readonly IListRepo _repository;
        private readonly IListService _listService;
        public GithubListController(IListRepo repository, IListService listService) 
        {
        ...
        {
            await _repository.UpdateUserList(id, name);
